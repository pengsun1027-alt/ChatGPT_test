...
2. **次要信息**: 16px 中等字重，slate-700 色
3. **辅助信息**: 14px 常规字重，slate-500 色
...
<div class="space-y-2">
	...
	<!-- 次要信息 -->
	<p class="text-base font-medium text-slate-700">运行状态：正常</p>

	<!-- 辅助信息 -->
	<p class="text-sm text-slate-500">最后检查：2小时前</p>
</div>
```
